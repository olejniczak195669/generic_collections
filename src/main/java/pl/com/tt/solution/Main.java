...
class AlgorithmService {
    ...
    public static void printAllRawItems(MyCollection myCollection) {
        ...
        for (int i = 0; i < myCollection.size(); i++) {
            Step step = (Step) myCollection.get(i); //Exception in thread "main" java.lang.ClassCastException: java.lang.String cannot be cast to Step
            print(step);
        }
    }
